...
but Sxyz is a LAZYEVAL, forExample.
<br><br>
...
and with 100%-epsilon efficiency of binary storage, where the epsilon is that binheap
doesnt use first array index and there are some other metadata to store in
...
public enum Leaf{
	...
	*/
	evalStepMyCostIsAtMostForestDepth,
